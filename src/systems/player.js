...
class Player {
    ...
    calculateSlidePosition(position, normal, deltaTime) {
        ...
        slidePosition.add(slideDirection.multiplyScalar(deltaTime)); // Use deltaTime for smooth sliding
...
window.Player = Player;        this.friction = 0.85;
        this.airFriction = 0.98;
