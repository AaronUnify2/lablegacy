...
export function setupInput() {
    ...
    // Make resetInputState available globally for game transitions
...
// Reset all input states - used when unpausing to prevent stuck keys
export function resetInputState() {
    ...
    // Reset UI control states (except pause which is handled separately)
    ...
    // Reset mobile joystick if needed
    if (inputState.isMobile && joystickKnob) {
...
function createActionButtons() {
    ...
    // SWAPPED: "L" and "Sword" buttons have swapped positions (row 2, col 0 and row 0, col 0)
    const buttons = [
        ['button-attack', 'Sword', 'rgba(205, 133, 63, 0.8)', 0, 0, 'attack'], // Moved Sword to top-left
        ...
        ['button-interact', 'L', 'rgba(100, 149, 237, 0.8)', 2, 0, 'interact'], // Moved L to bottom-left
