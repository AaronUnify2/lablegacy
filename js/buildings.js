...
window.GameBuildings = (function() {
    ...
    function drawFarm(ctx) {
        ...
        ctx.fillRect(22, 38, 9, 16);
        ctx.fillRect(33, 38, 9, 16);
        ctx.fillStyle = '#4a8a3a';
        ctx.fillRect(4, 56, 6, 8);
        ctx.fillRect(12, 58, 4, 6);
        ctx.fillRect(48, 56, 6, 8);
        ctx.fillRect(56, 58, 4, 6);
        ctx.strokeStyle = '#000';
        ctx.lineWidth = 2;
        ctx.strokeRect(10, 26, 44, 30);
    }
    
    function drawArrowTower(ctx) {
        ctx.fillStyle = '#3a3a3a';
        ctx.fillRect(20, 56, 24, 8);
        ctx.fillStyle = '#5a5a5a';
        ctx.fillRect(22, 20, 20, 40);
        ctx.fillStyle = '#4a4a4a';
        ctx.fillRect(22, 20, 6, 40);
        ctx.fillStyle = '#6a6a6a';
        ctx.fillRect(18, 16, 28, 6);
        ctx.fillStyle = '#5a5a5a';
        for (let i = 0; i < 5; i++) {
            ctx.fillRect(18 + i * 6, 10, 4, 8);
        }
        ctx.fillStyle = '#8B6914';
        ...
        ctx.beginPath();
        ctx.arc(32, 32, 4, Math.PI, 0, false);
        ctx.fill();
        ctx.strokeStyle = '#000';
        ctx.lineWidth = 2;
        ctx.strokeRect(22, 20, 20, 40);
    }
    ...
    function drawSawmill(ctx) {
        ...
        ctx.beginPath();
        ctx.arc(32, 42, 7, 0, Math.PI * 2);
        ctx.fill();
        ctx.fillStyle = '#808080';
        ctx.beginPath();
        ctx.arc(32, 42, 3, 0, Math.PI * 2);
        ctx.fill();
        for (let i = 0; i < 8; i++) {
            const angle = i * Math.PI / 4;
            ctx.fillStyle = '#606060';
            ctx.fillRect(
                32 + Math.cos(angle) * 4 - 1,
                42 + Math.sin(angle) * 4 - 1,
                2, 6
            );
        }
        ctx.fillStyle = '#5a4020';
        ctx.fillRect(4, 48, 12, 6);
        ctx.fillRect(6, 44, 8, 4);
        ctx.fillRect(48, 48, 12, 6);
        ctx.fillRect(50, 44, 8, 4);
        ctx.strokeStyle = '#000';
        ctx.lineWidth = 2;
        ctx.strokeRect(10, 30, 44, 26);
    }
    ...
    function drawGreenhouse(ctx) {
        ...
        ctx.fillRect(48, 24, 4, 32);
        ctx.fillRect(12, 24, 40, 4);
        ctx.fillRect(12, 38, 40, 3);
        ctx.fillRect(30, 24, 4, 32);
        ...
        ctx.closePath();
        ctx.fill();
        ctx.fillStyle = 'rgba(150, 220, 180, 0.5)';
        ctx.beginPath();
        ctx.moveTo(14, 24);
        ctx.lineTo(32, 12);
        ctx.lineTo(50, 24);
    ...
    function drawHive(ctx) {
        ...
        for (let i = 0; i < 5; i++) {
            const y = 20 + i * 8;
            const width = 32 - Math.abs(i - 2) * 4;
            const x = 32 - width/2;
            ctx.fillStyle = i % 2 === 0 ? '#d4a84a' : '#b8862b';
            ctx.fillRect(x, y, width, 8);
        }
        ctx.fillStyle = '#8B6914';
        ctx.beginPath();
        ctx.arc(32, 20, 14, Math.PI, 0, false);
        ctx.fill();
        ctx.fillStyle = '#2a1a0a';
        ctx.beginPath();
        ctx.arc(32, 56, 6, Math.PI, 0, false);
        ctx.fill();
        ctx.fillStyle = '#87ceeb';
        for (let i = 0; i < 3; i++) {
            ctx.save();
            ctx.translate(10 + i * 20 + Math.sin(i) * 4, 10 + i * 3);
            ctx.fillRect(-3, -2, 6, 4);
            ctx.fillStyle = 'rgba(200,200,255,0.5)';
            ctx.beginPath();
            ctx.ellipse(-4, 0, 3, 2, -0.3, 0, Math.PI * 2);
            ctx.fill();
            ctx.beginPath();
            ctx.ellipse(4, 0, 3, 2, 0.3, 0, Math.PI * 2);
            ctx.fill();
    ...
    function drawMageTower(ctx) {
        ...
        ctx.fillRect(24, 24, 16, 36);
        ctx.fillStyle = '#3a3a5a';
        ctx.fillRect(24, 24, 5, 36);
    ...
    function queueUnit(building) {
        ...
        // Check wood cost if present
        if (unitCost.wood && gameState.resources.wood < unitCost.wood) {
            console.log('Not enough wood!');
            return false;
        }
        
        // Check energy cost
        if (unitCost.energy && gameState.resources.energy < unitCost.energy) {
    ...
    function updateProduction(deltaTime) {
        ...
        gameState.buildings.forEach(building => {
            if (!building.typeData.unitType) return; // Skip non-producing buildings
            ...
            if (building.isProducing) {
                ...
                if (building.productionProgress >= building.typeData.productionTime) {
                    ...
                    // Spawn unit with building's upgrades
                    if (window.GameUnits) {
